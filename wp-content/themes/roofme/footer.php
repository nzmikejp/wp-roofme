    ...
    <footer class="light-footer">
      <div class="container">
        <p class="footer-info"><strong>MikesUI</strong> - Bootstrap 4 UI Kit. © 2020 - All Rights Reserved. <span class="pull-right">Designed by <a href="https://uideck.com">MikesUI</a></span></p>
      </div>
    </footer>
  </div>
  <!-- Page Wrapper End -->
